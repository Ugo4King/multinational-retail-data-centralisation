...
from data_cleaning.py import DataCleaning
import yaml
import pandas as pd
...
table_name = 'legal_user'
extract_table_data_from_AWS_RDS = DataExtractor(db_conectoin)#Calling the instance of the DataExtractor class 
...
extract_card_data_from_pdf = DataExtractor(db_conectoin)#Calling the instance of the DataExtractor class 
...
extract_store_data = DataExtractor(db_conectoin)#Calling the instance of the DataExtractor class 
...
clean_store_data_table = DataCleaning(store_data_table) #Calling the instance of the DataCleaning class
cleaned_store_data = clean_store_table.called_clean_store_data()
...
db_connection = DataConnector('db_creds.yaml') #Calling the instance of the DataConnector class 
extract_product_data = DataExtractor(db_conectoin) #Calling the instance of the DataExtractor class 
...
clean_product_weight = clean_product_data_table.convert_product_weights()
cleaned_product_data = clean_product_table.clean_products_data(clean_product_weight)
...
extract_user_table_data_from_AWS_RDS = DataExtractor(db_conectoin)#Calling the instance of the DataExtractor class 
...
extract_date_data = DataExtractor(db_conectoin) #Calling the instance of the DataExtractor class 
